...
|---|---|---|
| [GLORI-tools](https://github.com/liucongcas/GLORI-tools), Cong Liu | Adapted helper scripts in `pipelines/` and upstream portions incorporated into the amplicon workflow. The two amplicon entry points are local adaptations, not asserted to be upstream files. | [Original MIT license, Copyright (c) 2022 Cong Liu](LICENSES/GLORI-tools-MIT.txt) |
